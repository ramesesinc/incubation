...
public class Column_1 implements Serializable 
{    
    ...
    public Column_1(String name, String caption) 
    {
        this.name = name;
        this.caption = caption;
    }
    
    public Column_1( String name, String caption, String type, Map props) 
    {
        this(name, caption);
        this.type = type;
        if( props != null) {
    ...
    public Column_1( String name, String caption, String type, boolean editable, boolean required ) {
        this(name, caption, type, null, required);
        this.editable = editable;
    }
    
    public Column_1( String name, String caption, String type, Map props, boolean required ) {
        this(name, caption, type, props);
        this.required = required;
    }
    
    public Column_1( String name, String caption, String type, Map props, int width ) {
        this(name, caption, type, props);
        this.width = width;
    }
     ...
     */
    public Column_1 clone() {
        Column_1 col = new Column_1(getName(), getCaption());
        col.type = type;
        col.width = width;
    ...
    public final Column_1 set(String name, Object value) 
    {
        try 
        {
