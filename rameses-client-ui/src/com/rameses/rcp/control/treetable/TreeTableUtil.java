...
public final class TreeTableUtil {
    ...
    private static abstract class AbstractRenderer implements TableCellRenderer {
        ...
        public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
            ...
            TreeTableComponentModel xtableModel = (TreeTableComponentModel) xtable.getModel();
            ...
            if( column == 0 ) {
                ...
                if( !ValueUtil.isEmpty(colModel.getIconVisibleWhen()) ) {
                    try {
                        ...
                        iconVisible = UIControlUtil.evaluateExprBoolean(listItem.getItem(), colModel.getIconVisibleWhen()); 
                    } catch(Exception e) {;}
                }
    ...
    private static class StringRenderer extends AbstractRenderer {
        ...
        public void refresh(JTable table, Object value, boolean selected, boolean focus, int row, int column) {
            TreeTableComponent tc = (TreeTableComponent) table;
            Column c = ((TreeTableComponentModel) tc.getModel()).getColumn(column);
