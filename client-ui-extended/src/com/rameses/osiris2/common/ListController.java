...
{     
    ...
    public String getDomain() { return wudomain; }
    public String getRole() { return wurole; } 
    ...
    public List getFormActions() {
        if (formActions == null) {
            ...
            if (isAllowOpen()) { 
                ...
                loadPermissionDefaults(a, "open"); 
                loadPermission(a, getReadPermission());
                formActions.add(a); 
            }
    ...
    protected void handleWorkunitProperties(Map props) {
        ...
        wudomain = getString(props, "domain");
        wurole = getString(props, "role");
